...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=filter_applications" class="nav-item nav-filter_applications"><span class='icon-field'><i class="fa fa-user-tie"></i></span> Filter Applications</a>	
