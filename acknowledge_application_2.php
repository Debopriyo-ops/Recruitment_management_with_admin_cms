...
<html lang="en">
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4" style="background: #0000002e;">
                    	 <h1 class="text-uppercase text-white font-weight-bold">Acknowledgement Slip</h1>
    ...
    if ($application) {
        ...
        // Display the details
        echo "<span style='color: red; font-weight: bold;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Your Application ID: " . $id . "</span><br>";
...
<div id="preloader"></div>
    <footer class="bg-light py-5">
        ...
        <br>
        <div class="container">
            <div class="small text-center text-muted"><?php echo $_SESSION['setting_name'] ?> | <a
                    href="https://cybercrimewing.wb.gov.in/" target="_blank">WB-CCW, Govt. of West Bengal</a></div>
        </div>
    </footer>
